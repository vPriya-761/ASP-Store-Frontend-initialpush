      ...
      >
        <FlexBox className="topbarLeft" alignItems="center">
          <div className="logo">
            <Link href="/" passHref>
              <Image
                display="block"
                height="28px"
                src={'https://www.fabmerce.com/wp-content/uploads/2021/12/looo.png'}
                alt="logo"
              />
            </Link>
          </div>
          ...
          <FlexBox alignItems="center">
            ...
            <Span className="title">+91-7092134246</Span>
          </FlexBox>
          <FlexBox alignItems="center" ml={2.5}>
            <MailOutline fontSize="small" />
            <Span className="title">help.fabmerce@aptonshops.com</Span>
          </FlexBox>
        </FlexBox>
